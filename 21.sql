...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`lyerp` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `lyerp`;

/*Table structure for table `ly_admin_menu` */

DROP TABLE IF EXISTS `ly_admin_menu`;

CREATE TABLE `ly_admin_menu` (
...
/*Data for the table `ly_admin_menu` */

insert  into `ly_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values 
...
(162,0,0,1,10000,'lol','Team','default','','LOL','',''),
(163,0,0,1,10000,'nba','Team','default','','NBA','',''),
(164,162,1,1,10000,'lol','Team','teamList','','队伍管理','users',''),
(165,163,1,1,10000,'nba','Team','teamList','','队伍管理','users',''),
(166,162,1,1,10000,'lol','Schedule','scheduleList','','赛程管理','',''),
(167,163,1,1,10000,'nba','Schedule','scheduleList','','赛程管理','','');

/*Table structure for table `ly_asset` */

DROP TABLE IF EXISTS `ly_asset`;

CREATE TABLE `ly_asset` (
...
/*Data for the table `ly_asset` */

/*Table structure for table `ly_auth_access` */

DROP TABLE IF EXISTS `ly_auth_access`;

CREATE TABLE `ly_auth_access` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `ly_auth_access` */
...
insert  into `ly_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values 
...
(162,1,'lol','admin_url','lol/Team/default','','LOL',''),
(163,1,'nba','admin_url','nba/Team/default','','NBA',''),
(164,1,'LOL','admin_url','LOL/team/teamList','','队伍管理',''),
(165,1,'nba','admin_url','nba/Team/teamList','','队伍管理',''),
(166,1,'lol','admin_url','lol/Schedule/scheduleList','','赛程管理',''),
(167,1,'nba','admin_url','nba/Schedule/scheduleList','','赛程管理','');

/*Table structure for table `ly_comment` */
...
/*Data for the table `ly_comment` */

/*Table structure for table `ly_hook` */

DROP TABLE IF EXISTS `ly_hook`;

CREATE TABLE `ly_hook` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `ly_hook` */

insert  into `ly_hook`(`id`,`type`,`once`,`name`,`hook`,`app`,`description`) values 
...
/*Table structure for table `ly_hook_plugin` */

DROP TABLE IF EXISTS `ly_hook_plugin`;

CREATE TABLE `ly_hook_plugin` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `list_order` float NOT NULL DEFAULT '10000' COMMENT '排序',
...
/*Data for the table `ly_hook_plugin` */

/*Table structure for table `ly_link` */
...
/*Data for the table `ly_link` */

insert  into `ly_link`(`id`,`status`,`rating`,`list_order`,`description`,`url`,`name`,`image`,`target`,`rel`) values 
(1,1,1,8,'thinkcmf官网','http://www.thinkcmf.com','ThinkCMF','','_blank','');

/*Table structure for table `ly_lol_schedule` */

DROP TABLE IF EXISTS `ly_lol_schedule`;

CREATE TABLE `ly_lol_schedule` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `htd` int(11) NOT NULL COMMENT '主队id',
  `htn` varchar(100) NOT NULL COMMENT '主队名',
  `htp` int(11) DEFAULT NULL COMMENT '主队得分',
  `vtd` int(11) NOT NULL COMMENT '客队id',
  `vtn` varchar(100) NOT NULL COMMENT '客队名',
  `vtp` int(11) DEFAULT NULL COMMENT '客队得分',
  `gamedate` varchar(50) NOT NULL COMMENT '比赛日期',
  `gametime` int(11) NOT NULL COMMENT '比赛时间',
  `status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0 未开始 1以结束 2 取消',
  `type` tinyint(4) DEFAULT NULL COMMENT '赛事名称 夏季赛 春季赛==',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `ly_lol_schedule` */

/*Table structure for table `ly_lol_team` */

DROP TABLE IF EXISTS `ly_lol_team`;

CREATE TABLE `ly_lol_team` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL COMMENT '队名',
  `regtime` int(11) DEFAULT NULL COMMENT '队伍创建时间',
  `champion_num` tinyint(4) DEFAULT '0' COMMENT '冠军次数',
  `coach` varchar(100) DEFAULT NULL COMMENT '主教练',
  `icon` varchar(255) DEFAULT NULL COMMENT '队标img',
  `desc` text COMMENT '球队简介',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `ly_lol_team` */
...
/*Data for the table `ly_nav` */

insert  into `ly_nav`(`id`,`is_main`,`name`,`remark`) values 
(1,1,'主导航','主导航'),
(2,0,'底部导航','');

/*Table structure for table `ly_nav_menu` */

DROP TABLE IF EXISTS `ly_nav_menu`;

CREATE TABLE `ly_nav_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `ly_nav_menu` */

insert  into `ly_nav_menu`(`id`,`nav_id`,`parent_id`,`status`,`list_order`,`name`,`target`,`href`,`icon`,`path`) values 
(1,1,0,1,0,'首页','','home','','0-1');

/*Table structure for table `ly_nba_schedule` */

DROP TABLE IF EXISTS `ly_nba_schedule`;

CREATE TABLE `ly_nba_schedule` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `htd` int(11) NOT NULL COMMENT '主队id',
  `htn` varchar(100) NOT NULL COMMENT '主队名',
  `htp` int(11) DEFAULT NULL COMMENT '主队得分',
  ...
  `gamedate` varchar(50) NOT NULL COMMENT '比赛日期',
  `gametime` int(11) NOT NULL COMMENT '比赛时间',
  `status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0 未开始 1已结束 2 取消',
  `type` tinyint(4) DEFAULT NULL COMMENT '赛事名称 夏季赛 春季赛==',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`)
...
/*Data for the table `ly_nba_schedule` */

/*Table structure for table `ly_nba_team` */

DROP TABLE IF EXISTS `ly_nba_team`;

CREATE TABLE `ly_nba_team` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL COMMENT '队名',
  `regtime` int(11) DEFAULT NULL COMMENT '球队创建时间',
  `champion_num` tinyint(4) DEFAULT '0' COMMENT '冠军次数',
  `coach` varchar(100) DEFAULT NULL COMMENT '主教练',
  `icon` varchar(255) DEFAULT NULL COMMENT '队标img',
  `desc` text COMMENT '球队简介',
...
/*Data for the table `ly_nba_team` */

/*Table structure for table `ly_option` */

DROP TABLE IF EXISTS `ly_option`;

CREATE TABLE `ly_option` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='全站配置表';

/*Data for the table `ly_option` */

insert  into `ly_option`(`id`,`autoload`,`option_name`,`option_value`) values 
(1,1,'site_info','{\"site_name\":\"L&amp;Y\\u4e61\\u91ce\\u5546\\u57ce\\u8fdb\\u9500\\u5b58\",\"site_seo_title\":\"L&amp;Y\\u4e61\\u91ce\\u5546\\u57ce\\u8fdb\\u9500\\u5b58\",\"site_seo_keywords\":\"L&amp;Y,\\u4e61\\u91ce\\u5546\\u57ce,php\\uff0cERP\",\"site_seo_description\":\"\\u4e61\\u91ce\\u5546\\u57ce\\u7684\\u8fdb\\u9500\\u5b58\\u7cfb\\u7edf\"}');

/*Table structure for table `ly_plugin` */

DROP TABLE IF EXISTS `ly_plugin`;

CREATE TABLE `ly_plugin` (
...
/*Data for the table `ly_plugin` */

/*Table structure for table `ly_portal_category` */

DROP TABLE IF EXISTS `ly_portal_category`;

CREATE TABLE `ly_portal_category` (
...
/*Data for the table `ly_portal_category` */

/*Table structure for table `ly_portal_category_post` */

DROP TABLE IF EXISTS `ly_portal_category_post`;

CREATE TABLE `ly_portal_category_post` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `ly_portal_category_post` */

/*Table structure for table `ly_portal_post` */

DROP TABLE IF EXISTS `ly_portal_post`;

CREATE TABLE `ly_portal_post` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `ly_portal_post` */

/*Table structure for table `ly_portal_tag` */

DROP TABLE IF EXISTS `ly_portal_tag`;

CREATE TABLE `ly_portal_tag` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '分类id',
  `status` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '状态,1:发布,0:不发布',
  `recommended` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否推荐;1:推荐;0:不推荐',
...
/*Data for the table `ly_portal_tag` */

/*Table structure for table `ly_portal_tag_post` */

DROP TABLE IF EXISTS `ly_portal_tag_post`;

CREATE TABLE `ly_portal_tag_post` (
...
/*Data for the table `ly_portal_tag_post` */

/*Table structure for table `ly_recycle_bin` */

DROP TABLE IF EXISTS `ly_recycle_bin`;

CREATE TABLE `ly_recycle_bin` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `ly_recycle_bin` */
...
insert  into `ly_role`(`id`,`parent_id`,`status`,`create_time`,`update_time`,`list_order`,`name`,`remark`) values 
(1,0,1,1329633709,1329633709,0,'超级管理员','拥有网站最高管理员权限！'),
(2,0,1,1329633709,1329633709,0,'普通管理员','权限由最高管理员分配！');

/*Table structure for table `ly_role_user` */

DROP TABLE IF EXISTS `ly_role_user`;

CREATE TABLE `ly_role_user` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `ly_role_user` */

insert  into `ly_role_user`(`id`,`role_id`,`user_id`) values 
(1,1,2);

/*Table structure for table `ly_route` */

DROP TABLE IF EXISTS `ly_route`;
...
/*Data for the table `ly_slide` */

/*Table structure for table `ly_slide_item` */

DROP TABLE IF EXISTS `ly_slide_item`;

CREATE TABLE `ly_slide_item` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `ly_slide_item` */
...
insert  into `ly_theme`(`id`,`create_time`,`update_time`,`status`,`is_compiled`,`theme`,`name`,`version`,`demo_url`,`thumbnail`,`author`,`author_url`,`lang`,`keywords`,`description`) values 
...
/*Table structure for table `ly_theme_file` */

DROP TABLE IF EXISTS `ly_theme_file`;

CREATE TABLE `ly_theme_file` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `ly_theme_file` */

insert  into `ly_theme_file`(`id`,`is_public`,`list_order`,`theme`,`name`,`action`,`file`,`description`,`more`,`config_more`,`draft_more`) values 
...
/*Table structure for table `ly_third_party_user` */

DROP TABLE IF EXISTS `ly_third_party_user`;

CREATE TABLE `ly_third_party_user` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `ly_third_party_user` */
...
insert  into `ly_user`(`id`,`user_type`,`sex`,`birthday`,`last_login_time`,`score`,`coin`,`balance`,`create_time`,`user_status`,`user_login`,`user_pass`,`user_nickname`,`user_email`,`user_url`,`avatar`,`signature`,`last_login_ip`,`user_activation_key`,`mobile`,`more`) values 
(1,1,0,0,1530630493,0,0,0.00,1523712794,1,'ly2018','###e571e627856f2d62f92f49f9cde72d7e','ly2018','790634104@qq.com','','','','127.0.0.1','','',NULL),
(2,1,0,0,0,0,0,0.00,0,1,'20180501','###e571e627856f2d62f92f49f9cde72d7e','','1037494700@qq.com','','','','','','',NULL);

/*Table structure for table `ly_user_action` */

DROP TABLE IF EXISTS `ly_user_action`;

CREATE TABLE `ly_user_action` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `ly_user_action` */

insert  into `ly_user_action`(`id`,`score`,`coin`,`reward_number`,`cycle_type`,`cycle_time`,`name`,`action`,`app`,`url`) values 
(1,1,1,1,2,1,'用户登录','login','user','');

/*Table structure for table `ly_user_action_log` */

DROP TABLE IF EXISTS `ly_user_action_log`;

CREATE TABLE `ly_user_action_log` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
...
/*Data for the table `ly_user_action_log` */

/*Table structure for table `ly_user_balance_log` */

DROP TABLE IF EXISTS `ly_user_balance_log`;

CREATE TABLE `ly_user_balance_log` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `ly_user_balance_log` */

/*Table structure for table `ly_user_favorite` */

DROP TABLE IF EXISTS `ly_user_favorite`;

CREATE TABLE `ly_user_favorite` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `ly_user_favorite` */

/*Table structure for table `ly_user_login_attempt` */

DROP TABLE IF EXISTS `ly_user_login_attempt`;

CREATE TABLE `ly_user_login_attempt` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `ly_user_login_attempt` */

/*Table structure for table `ly_user_score_log` */
...
/*Data for the table `ly_user_score_log` */

/*Table structure for table `ly_user_token` */

DROP TABLE IF EXISTS `ly_user_token`;

CREATE TABLE `ly_user_token` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `ly_user_token` */

insert  into `ly_user_token`(`id`,`user_id`,`expire_time`,`create_time`,`token`,`device_type`) values 
(1,1,1539265090,1523713090,'44b635a45d3f45da1b347faeeb4a53f644b635a45d3f45da1b347faeeb4a53f6','web');

/*Table structure for table `ly_verification_code` */

DROP TABLE IF EXISTS `ly_verification_code`;

CREATE TABLE `ly_verification_code` (
...
/*Data for the table `ly_verification_code` */
